  ...
  return (
    <main>
      ...
      <section className="px-4 md:px-8 py-10 md:py-14">
        <h2 className="font-baksosapi text-xl md:text-2xl text-gray-900 mb-6">
          Shop by Category
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {[
            ...
            { label: "Sets", link: "/shop?category=sets", icon: "/icons/tops.png" },
            { label: "Outerwear", link: "/shop?category=outerwear", icon: "/icons/tops.png" },
            { label: "Accessories", link: "/shop?category=accessories", icon: "/icons/hat.png" },
          ].map((cat) => (
              <a
              key={cat.label}
              href={cat.link}
      ...
      <section className="px-4 md:px-8 py-8 md:py-12 bg-white">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <h2 className="font-baksosapi text-xl md:text-2xl">New Arrivals</h2>
          <Link
            to="/catalog"
      ...
      <section className="mx-4 md:mx-8 mb-8 md:mb-12 bg-gray-900 text-white rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h2 className="italic font-Coiny text-2xl md:text-3xl font-medium">
            New <em className="italic font-Coiny">arrivals</em> just landed
          </h2>
